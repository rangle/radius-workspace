  ...
  if (consoleOutput) {
    ...
    files.forEach(([fileName, content]) => {
      ...
      if (existsSync(filePath)) {
        console.log(filePath, "file exists. overwriting");
      }
      console.log("Writing", fileName, content);
      !dryRun && writeFileSync(filePath, content);
    });
  }
};

// const obj = generateGlobalStyles({
//   url: "https://www.figma.com/file/TJzz7ZB6pJvpLhjI5DWG3F/Radius-Design-Kit-V2(WIP)?node-id=725%3A8261",
//   userToken: "226491-6f230b11-90f8-40e3-80e2-1ebdf926fbdb",
// });
